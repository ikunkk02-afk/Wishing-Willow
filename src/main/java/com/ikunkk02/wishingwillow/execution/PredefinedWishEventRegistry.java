...
public final class PredefinedWishEventRegistry {
    ...
    public static final String ALL_POSITIVE_EFFECTS="wishing_willow:all_positive_effects";
    private static final Set<String> WORLD_EVENT_IDS=Set.of(STALKER,ENDLESS_NIGHT,OMINOUS_STORM);
    private static final Set<String> IDS=Set.of(STALKER,ENDLESS_NIGHT,OMINOUS_STORM,ALL_POSITIVE_EFFECTS);
    ...
    public static Set<String> worldEventIds(){return WORLD_EVENT_IDS;}
}
