...
class WishMusicStateMachineTest {
    @Test void wishSequenceReplacesTradeAndTradeCannotInterruptWish() {
        ...
        assertEquals(WishMusicStateMachine.Action.REPLACE, state.start(WishMusicScene.WISH_SEQUENCE));
